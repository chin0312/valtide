...
export function StatusStrip({
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 rounded-lg px-4 py-2.5 text-xs" style={{ background: "var(--color-panel)", border: "1px solid var(--color-line-subtle)" }}>
      ...
      {onchainFresh != null && (
        <span
          className="inline-flex items-center gap-1.5 rounded px-2 py-0.5 font-mono text-[10px] font-medium"
          style={{
      ...
      <span
        className="ml-auto inline-flex items-center gap-1.5 rounded px-2 py-1 font-mono text-[10px] font-medium uppercase tracking-[0.03em]"
        style={{
